...
```bash
source_url "https://raw.githubusercontent.com/simlans/direnv-libs/v1.0.0/op-cache.sh" "sha256-<hash>"
```
...
1. Check the [releases](https://github.com/simlans/direnv-libs/releases) for the latest version
2. Generate the SHA256 hash (base64-encoded) for the new version:
   ...
   ```bash
   source_url "https://raw.githubusercontent.com/simlans/direnv-libs/vX.Y.Z/op-cache.sh" "sha256-UCLdQe1O..."
   ```
